...
public class EventUtils {
    ...
    private static Map<String, EventUtils> eventMap = new HashMap<String, EventUtils>();
    private static String DEFAULT_EVENT = "APP_EVENT";
     ...
     * @return EventUtils
     */
    public static EventUtils getEvent(String eventName) {
